...
- **[A14 Physical Pointer Routing](INPUT_ROUTING_A14.md)**: Routing mice and touchpads to displays on Android 14+.
...
### Restore preferences
SmartDock DFC allows restoring preferences from a backup with a shell command. Refer to the inline documentation in `PreferencesReceiver` (`app/src/main/java/cu/axel/smartdock/receivers/PreferencesReceiver.kt` in the SmartDock-DFC source).
...
On Lineout / ax86-lite builds, enable it with `--smartdock`.
