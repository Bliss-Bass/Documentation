...
Current Lineout tablet builds use `vendor/ax86-lite/tools/build.sh`. Run `./build.sh -h` for the full list. The flags below cover the newer apps and fleet options documented here.
